                            ...
                            <div class="row"> @csrf
                                ...
                                <div class="col-md-5">
                                   <table class="w-100 mt-2"  style="">
                                       ...
                                       <tr> <td><label for="">Vendor Name</label></td> <td> 
                                                 <select name="vendor_id" id="vendor_ids" class="inv_inp" required>
                                                     <option value="{{$trans_doc->vendor_id}}">{{$trans_doc->vendor->full_name}}</option>
                                   ...
                                   <table class="w-100"  style="" id="vendor_data">
                                    <tr> <td><label for="">Street Address</label></td> <td><input type="text" class="inv_inp" value="{{$trans_doc->vendor->address}}"></td>  </tr>
                                    <tr> <td><label for="">Phone No</label></td> <td><input type="text" class="inv_inp" value="{{$trans_doc->vendor->phone_a}}"></td>  </tr>
                                    <tr> <td><label for="">E-Mail</label></td> <td><input type="text" class="inv_inp"  value="{{$trans_doc->vendor->user->email}}"></td>  </tr>
